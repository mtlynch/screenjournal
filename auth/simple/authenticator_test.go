...
type (
	...
	mockAuthEntry struct {
		Username     string
		PasswordHash simple.PasswordHash
	}
...
func newMockPasswordHash(password string) simple.PasswordHash {
...
func (s mockAuthStore) ReadPasswordHash(username string) (simple.PasswordHash, error) {
