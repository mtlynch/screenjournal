...
func (s *Server) routes() {
	...
	authenticatedApis.HandleFunc("/reviews/{reviewID}/comment/{commentID}", s.commentsPut()).Methods(http.MethodPut)
	authenticatedApis.HandleFunc("/reviews/{reviewID}/comment/{commentID}", s.commentsDelete()).Methods(http.MethodDelete)
