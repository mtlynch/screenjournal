...
func (s *Server) routes() {
	...
	views.HandleFunc("/forgot-password", s.forgotPasswordGet()).Methods(http.MethodGet)
	views.HandleFunc("/forgot-password", s.forgotPasswordPost()).Methods(http.MethodPost)
