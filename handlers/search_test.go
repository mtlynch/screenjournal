...
<ul class="py-0 my-0 list-unstyled border border-success">
	<li>
			<a
				href="/reviews/new/write?tmdbId=1&media-type=movie"
	...
	<li>
			<a
				href="/reviews/new/write?tmdbId=2&media-type=movie"
...
<ul class="py-0 my-0 list-unstyled border border-success">
	<li>
			<a
				href="/reviews/new/write?tmdbId=3&media-type=tv-show"
	...
	<li>
			<a
				href="/reviews/new/write?tmdbId=4&media-type=tv-show"
